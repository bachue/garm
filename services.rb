  ...
  module Service
    class ProjectQuickLoader
      ...
      def self.resolved_percent project
        ...
        count > 0 ? 100 * resolved_count / count : 100
      end
    end
    ...
    class ExceptionCategoryQuickLoader
      def self.load project, category_limit = :all, exception_limit = :all, *conditions
        ...
        categories.each_with_index do |category, idx|
          ...
          hash[idx]['version_distribution'] = category.occurrence_count_version_distribution
          hash[idx]['date_distribution'] = category.occurrence_count_date_distribution
        end
        hash
      end
    end
